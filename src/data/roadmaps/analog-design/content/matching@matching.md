...
- [Coursera] analog IC layout matching techniques(https://www.udemy.com/courses/search/?q=analog+IC+layout+matching+techniques)
- [YouTube] common centroid layout device matching analog(https://www.youtube.com/results?search_query=common+centroid+layout+device+matching+analog)
