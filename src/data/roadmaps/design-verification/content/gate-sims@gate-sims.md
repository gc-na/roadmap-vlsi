...
- [@course@gate level simulation ASIC](https://www.udemy.com/courses/search/?q=gate+level+simulation+ASIC)
- [@video@gate level simulation SDF X-propagation tutorial](https://www.youtube.com/results?search_query=gate+level+simulation+SDF+X-propagation+tutorial)
- [@article@gate level simulation](https://vlsi.kr/?s=gate+level+simulation)
